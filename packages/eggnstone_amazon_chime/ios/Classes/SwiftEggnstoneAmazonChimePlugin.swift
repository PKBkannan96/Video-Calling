...
public class SwiftEggnstoneAmazonChimePlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        switch call.method {
            ...
            case "SwitchCamera": self.handleSwitchCamera(result: result)
...
//    }
    ...
    func handleSwitchCamera(result: @escaping FlutterResult) {
        if checkAudioVideoFacade(result: result, source: "SwitchCamera") == false {
            return
        }
        _audioVideoFacade?.switchCamera()
        result(nil)
    }
}
